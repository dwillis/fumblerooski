...
from football.recruits import views as recruit_views
from football.college import views as college_views
...
#     (r'^recruits/positions/(?P<pos>\w{2,3})/height/under-six-foot/$', recruit_views.position_height_under_six),
     ...
     (r'^recruits/states/$', recruit_views.state_index),
     (r'^recruits/states/(?P<state>[a-z][a-z])/$', recruit_views.state_detail),
     (r'^recruits/states/(?P<state>[a-z][a-z])/(?P<pos>[a-z][a-z]?[a-z]?)/$', recruit_views.state_position_index),
     (r'^recruits/states/(?P<state>[a-z][a-z])/(?P<city>[-a-z]+)/$', recruit_views.city_index),
     (r'^recruits/states/(?P<state>[a-z][a-z])/(?P<city>[-a-z]+)/(?P<school>[-a-z]+)/$', recruit_views.school_detail),
     (r'^recruits/states/(?P<state>[a-z][a-z])/(?P<city>[-a-z]+)/(?P<school>[-a-z]+)/(?P<pos>[a-z][a-z]?[a-z]?)/$', recruit_views.school_detail),
)
