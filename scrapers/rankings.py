    ...
    for team in teams:
        ...
        if rankings:
            ...
            for row in rows:
                ...
                r, created = Ranking.objects.get_or_create(ranking_type=rt, collegeyear=cy, year=year, week=w, rank=rk, is_tied = i_t, actual=float(cells[2].contents[0]), conference_rank=cr, is_conf_tied=ic_t, division = cy.division)
